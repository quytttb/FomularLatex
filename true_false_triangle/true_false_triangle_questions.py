...
def generate_question(question_number):
    ...
    false_m_value = round(m_value + random.choice([-0.5, 0.5, -1, 1]), 1)
    ...
    false_m_value_formatted = format_m_value(false_m_value)
    
    propositions.append({
        'true': f"Bốn điểm {l1}, {l2}, {l3}, D({x_d}; {y_d}; {z_expr}) đồng phẳng khi m = {m_value_formatted}.",
        'false': f"Bốn điểm {l1}, {l2}, {l3}, D({x_d}; {y_d}; {z_expr}) đồng phẳng khi m = {false_m_value_formatted}.",
        'x_d': x_d,
        'y_d': y_d,
        'a_coeff': a_coeff,
        'b_const': b_const,
