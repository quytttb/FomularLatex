...
a) Quãng đường ô tô đi được từ khi phát hiện biển báo giới hạn tốc độ đến khi bắt đầu giảm tốc độ (trong ${t_react} giây với vận tốc ${v0} m/s) là \(${v0} \cdot ${t_react} = ${d_react}\) m.

b) \(v_1(0) = ${v0} \Leftrightarrow b = ${v0} \Rightarrow v_1(t) = at + ${v0}\) m/s.

c) Ô tô đến vị trí đặt biển báo tốc độ tối đa cho phép sau \(t\) giây kể từ khi giảm tốc khi \(v_1(t) = at + ${v0} = ${v_sign} \Leftrightarrow t = -\dfrac{${v0_minus_vsign}}{a}\) và quãng đường đi được trong khoảng thời gian đó là \(\displaystyle\int_0^{t} v_1(t) \, dt = ${d_decel} \Leftrightarrow \displaystyle\int_0^{-\frac{${v0_minus_vsign}}{a}} (at + ${v0}) \, dt = ${d_decel} \Leftrightarrow a = -\dfrac{${v0_minus_vsign}}{${t_decel}} \Rightarrow t = ${t_decel}\).

d) Ta có \(v_2(0) = ${v_sign} \Leftrightarrow n = ${v_sign}\); \(v_2(${t_accel}) = ${v_final} \Leftrightarrow ${t_accel}m + ${v_sign} = ${v_final} \Leftrightarrow m = ${m_val} \Rightarrow v_2(t_1) = ${m_val_display}t_1 + ${v_sign}\) m/s.

Quãng đường ô tô đi được kể từ khi tăng tốc đến khi đạt vận tốc ${v_final_kmh} km/h là \(\displaystyle\int_0^{${t_accel}} v_2(t_1) \, dt_1 = \displaystyle\int_0^{${t_accel}} \left(${m_val_display}t_1 + ${v_sign}\right) dt_1 = ${d_accel}\) m.
...
a) Quãng đường xe tải đi được từ khi phát hiện biển báo giới hạn tốc độ đến khi bắt đầu giảm tốc độ (trong ${t_react} giây với vận tốc ${v0} m/s) là \(${v0} \cdot ${t_react} = ${d_react}\) m.

b) \(v_1(0) = ${v0} \Leftrightarrow b = ${v0} \Rightarrow v_1(t) = at + ${v0}\) m/s.

c) Xe tải đến vị trí đặt biển báo tốc độ tối đa cho phép sau \(t\) giây kể từ khi giảm tốc khi \(v_1(t) = at + ${v0} = ${v_sign} \Leftrightarrow t = -\dfrac{${v0_minus_vsign}}{a}\) và quãng đường đi được trong khoảng thời gian đó là \(\displaystyle\int_0^{t} v_1(t) \, dt = ${d_decel} \Leftrightarrow \displaystyle\int_0^{-\frac{${v0_minus_vsign}}{a}} (at + ${v0}) \, dt = ${d_decel} \Leftrightarrow a = -\dfrac{${v0_minus_vsign}}{${t_decel}} \Rightarrow t = ${t_decel}\).

d) Ta có \(v_2(0) = ${v_sign} \Leftrightarrow n = ${v_sign}\); \(v_2(${t_accel}) = ${v_final} \Leftrightarrow ${t_accel}m + ${v_sign} = ${v_final} \Leftrightarrow m = ${m_val} \Rightarrow v_2(t_1) = ${m_val_display}t_1 + ${v_sign}\) m/s.

Quãng đường xe tải đi được kể từ khi tăng tốc đến khi đạt vận tốc ${v_final_kmh} km/h là \(\displaystyle\int_0^{${t_accel}} v_2(t_1) \, dt_1 = \displaystyle\int_0^{${t_accel}} \left(${m_val_display}t_1 + ${v_sign}\right) dt_1 = ${d_accel}\) m.
...
a) Quãng đường xe buýt đi được từ khi phát hiện biển báo giới hạn tốc độ đến khi bắt đầu giảm tốc độ (trong ${t_react} giây với vận tốc ${v0} m/s) là \(${v0} \cdot ${t_react} = ${d_react}\) m.

b) \(v_1(0) = ${v0} \Leftrightarrow b = ${v0} \Rightarrow v_1(t) = at + ${v0}\) m/s.

c) Xe buýt đến vị trí đặt biển báo tốc độ tối đa cho phép sau \(t\) giây kể từ khi giảm tốc khi \(v_1(t) = at + ${v0} = ${v_sign} \Leftrightarrow t = -\dfrac{${v0_minus_vsign}}{a}\) và quãng đường đi được trong khoảng thời gian đó là \(\displaystyle\int_0^{t} v_1(t) \, dt = ${d_decel} \Leftrightarrow \displaystyle\int_0^{-\frac{${v0_minus_vsign}}{a}} (at + ${v0}) \, dt = ${d_decel} \Leftrightarrow a = -\dfrac{${v0_minus_vsign}}{${t_decel}} \Rightarrow t = ${t_decel}\).

d) Ta có \(v_2(0) = ${v_sign} \Leftrightarrow n = ${v_sign}\); \(v_2(${t_accel}) = ${v_final} \Leftrightarrow ${t_accel}m + ${v_sign} = ${v_final} \Leftrightarrow m = ${m_val} \Rightarrow v_2(t_1) = ${m_val_display}t_1 + ${v_sign}\) m/s.

Quãng đường xe buýt đi được kể từ khi tăng tốc đến khi đạt vận tốc ${v_final_kmh} km/h là \(\displaystyle\int_0^{${t_accel}} v_2(t_1) \, dt_1 = \displaystyle\int_0^{${t_accel}} \left(${m_val_display}t_1 + ${v_sign}\right) dt_1 = ${d_accel}\) m.
...
a) Quãng đường taxi đi được từ khi phát hiện biển báo giới hạn tốc độ đến khi bắt đầu giảm tốc độ (trong ${t_react} giây với vận tốc ${v0} m/s) là \(${v0} \cdot ${t_react} = ${d_react}\) m.

b) \(v_1(0) = ${v0} \Leftrightarrow b = ${v0} \Rightarrow v_1(t) = at + ${v0}\) m/s.

c) Taxi đến vị trí đặt biển báo tốc độ tối đa cho phép sau \(t\) giây kể từ khi giảm tốc khi \(v_1(t) = at + ${v0} = ${v_sign} \Leftrightarrow t = -\dfrac{${v0_minus_vsign}}{a}\) và quãng đường đi được trong khoảng thời gian đó là \(\displaystyle\int_0^{t} v_1(t) \, dt = ${d_decel} \Leftrightarrow \displaystyle\int_0^{-\frac{${v0_minus_vsign}}{a}} (at + ${v0}) \, dt = ${d_decel} \Leftrightarrow a = -\dfrac{${v0_minus_vsign}}{${t_decel}} \Rightarrow t = ${t_decel}\).

d) Ta có \(v_2(0) = ${v_sign} \Leftrightarrow n = ${v_sign}\); \(v_2(${t_accel}) = ${v_final} \Leftrightarrow ${t_accel}m + ${v_sign} = ${v_final} \Leftrightarrow m = ${m_val} \Rightarrow v_2(t_1) = ${m_val_display}t_1 + ${v_sign}\) m/s.

Quãng đường taxi đi được kể từ khi tăng tốc đến khi đạt vận tốc ${v_final_kmh} km/h là \(\displaystyle\int_0^{${t_accel}} v_2(t_1) \, dt_1 = \displaystyle\int_0^{${t_accel}} \left(${m_val_display}t_1 + ${v_sign}\right) dt_1 = ${d_accel}\) m.
...
a) Quãng đường xe đạp điện đi được từ khi phát hiện biển báo giới hạn tốc độ đến khi bắt đầu giảm tốc độ (trong ${t_react} giây với vận tốc ${v0} m/s) là \(${v0} \cdot ${t_react} = ${d_react}\) m.
...
Quãng đường xe đạp điện đi được kể từ khi tăng tốc đến khi đạt vận tốc ${v_final_kmh} km/h là \(\displaystyle\int_0^{${t_accel}} v_2(t_1) \, dt_1 = \displaystyle\int_0^{${t_accel}} \left(${m_val_display}t_1 + ${v_sign}\right) dt_1 = ${d_accel}\) m.
...
a) Quãng đường xe cứu thương đi được từ khi phát hiện biển báo giới hạn tốc độ đến khi bắt đầu giảm tốc độ (trong ${t_react} giây với vận tốc ${v0} m/s) là \(${v0} \cdot ${t_react} = ${d_react}\) m.

b) \(v_1(0) = ${v0} \Leftrightarrow b = ${v0} \Rightarrow v_1(t) = at + ${v0}\) m/s.

c) Xe cứu thương đến vị trí đặt biển báo tốc độ tối đa cho phép sau \(t\) giây kể từ khi giảm tốc khi \(v_1(t) = at + ${v0} = ${v_sign} \Leftrightarrow t = -\dfrac{${v0_minus_vsign}}{a}\) và quãng đường đi được trong khoảng thời gian đó là \(\displaystyle\int_0^{t} v_1(t) \, dt = ${d_decel} \Leftrightarrow \displaystyle\int_0^{-\frac{${v0_minus_vsign}}{a}} (at + ${v0}) \, dt = ${d_decel} \Leftrightarrow a = -\dfrac{${v0_minus_vsign}}{${t_decel}} \Rightarrow t = ${t_decel}\).

d) Ta có \(v_2(0) = ${v_sign} \Leftrightarrow n = ${v_sign}\); \(v_2(${t_accel}) = ${v_final} \Leftrightarrow ${t_accel}m + ${v_sign} = ${v_final} \Leftrightarrow m = ${m_val} \Rightarrow v_2(t_1) = ${m_val_display}t_1 + ${v_sign}\) m/s.

Quãng đường xe cứu thương đi được kể từ khi tăng tốc đến khi đạt vận tốc ${v_final_kmh} km/h là \(\displaystyle\int_0^{${t_accel}} v_2(t_1) \, dt_1 = \displaystyle\int_0^{${t_accel}} \left(${m_val_display}t_1 + ${v_sign}\right) dt_1 = ${d_accel}\) m.
...
a) Quãng đường xe khách đi được từ khi phát hiện biển báo giới hạn tốc độ đến khi bắt đầu giảm tốc độ (trong ${t_react} giây với vận tốc ${v0} m/s) là \(${v0} \cdot ${t_react} = ${d_react}\) m.

b) \(v_1(0) = ${v0} \Leftrightarrow b = ${v0} \Rightarrow v_1(t) = at + ${v0}\) m/s.

c) Xe khách đến vị trí đặt biển báo tốc độ tối đa cho phép sau \(t\) giây kể từ khi giảm tốc khi \(v_1(t) = at + ${v0} = ${v_sign} \Leftrightarrow t = -\dfrac{${v0_minus_vsign}}{a}\) và quãng đường đi được trong khoảng thời gian đó là \(\displaystyle\int_0^{t} v_1(t) \, dt = ${d_decel} \Leftrightarrow \displaystyle\int_0^{-\frac{${v0_minus_vsign}}{a}} (at + ${v0}) \, dt = ${d_decel} \Leftrightarrow a = -\dfrac{${v0_minus_vsign}}{${t_decel}} \Rightarrow t = ${t_decel}\).

d) Ta có \(v_2(0) = ${v_sign} \Leftrightarrow n = ${v_sign}\); \(v_2(${t_accel}) = ${v_final} \Leftrightarrow ${t_accel}m + ${v_sign} = ${v_final} \Leftrightarrow m = ${m_val} \Rightarrow v_2(t_1) = ${m_val_display}t_1 + ${v_sign}\) m/s.

Quãng đường xe khách đi được kể từ khi tăng tốc đến khi đạt vận tốc ${v_final_kmh} km/h là \(\displaystyle\int_0^{${t_accel}} v_2(t_1) \, dt_1 = \displaystyle\int_0^{${t_accel}} \left(${m_val_display}t_1 + ${v_sign}\right) dt_1 = ${d_accel}\) m.
...
a) Quãng đường xe container đi được từ khi phát hiện biển báo giới hạn tốc độ đến khi bắt đầu giảm tốc độ (trong ${t_react} giây với vận tốc ${v0} m/s) là \(${v0} \cdot ${t_react} = ${d_react}\) m.

b) \(v_1(0) = ${v0} \Leftrightarrow b = ${v0} \Rightarrow v_1(t) = at + ${v0}\) m/s.

c) Xe container đến vị trí đặt biển báo tốc độ tối đa cho phép sau \(t\) giây kể từ khi giảm tốc khi \(v_1(t) = at + ${v0} = ${v_sign} \Leftrightarrow t = -\dfrac{${v0_minus_vsign}}{a}\) và quãng đường đi được trong khoảng thời gian đó là \(\displaystyle\int_0^{t} v_1(t) \, dt = ${d_decel} \Leftrightarrow \displaystyle\int_0^{-\frac{${v0_minus_vsign}}{a}} (at + ${v0}) \, dt = ${d_decel} \Leftrightarrow a = -\dfrac{${v0_minus_vsign}}{${t_decel}} \Rightarrow t = ${t_decel}\).

d) Ta có \(v_2(0) = ${v_sign} \Leftrightarrow n = ${v_sign}\); \(v_2(${t_accel}) = ${v_final} \Leftrightarrow ${t_accel}m + ${v_sign} = ${v_final} \Leftrightarrow m = ${m_val} \Rightarrow v_2(t_1) = ${m_val_display}t_1 + ${v_sign}\) m/s.

Quãng đường xe container đi được kể từ khi tăng tốc đến khi đạt vận tốc ${v_final_kmh} km/h là \(\displaystyle\int_0^{${t_accel}} v_2(t_1) \, dt_1 = \displaystyle\int_0^{${t_accel}} \left(${m_val_display}t_1 + ${v_sign}\right) dt_1 = ${d_accel}\) m.
...
class MotorcycleQuestion:
    ...
    def generate_parameters(self):
        ...
        # Pre-computed nice combinations
        # Format: (v0_ms, v_sign_ms, v_final_ms) all in m/s
        # Common km/h values: 18->5, 36->10, 54->15, 72->20, 90->25
        velocity_combos = [
        ...
        self.t_react = random.randint(1, 3)
        ...
        # Ensure parity match for integer distance
        if (self.v0 + self.v_sign) % 2 != 0:
            # sum is odd, t_decel must be even
            self.t_decel = random.choice([2, 4, 6])
        else:
            self.t_decel = random.choice([2, 3, 4, 5, 6])
        ...
        self.t_accel = random.choice([2, 3, 4, 5, 6])
    ...
    def generate_question(self, idx: int) -> str:
        ...
        # Use the scenario's templates for question and solution
        question = self.scenario['template_q'].substitute(params)
        solution = self.scenario['template_sol'].substitute(params)
...
def main():
    ...
    output_path = os.path.join(os.path.dirname(__file__), "bai_toan_giao_thong.tex")
    with open(output_path, "w", encoding="utf-8") as f:
        f.write(latex)
    print(f"Đã tạo {num_questions} câu hỏi trong bai_toan_giao_thong.tex")
