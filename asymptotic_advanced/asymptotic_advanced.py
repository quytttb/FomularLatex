...
def generate_single_question(question_number):
    ...
    question_content += f"\\begin{{itemize}}\n"
    question_content += f"    \\item Tiệm cận đứng: \n"
    question_content += f"    \\(x = {tiemcan_dung} \\Rightarrow n = {n_value_calc}\\)\n"
    question_content += f"    \\item Tiệm cận ngang:\n"
    question_content += f"    \\(y = {tiemcan_ngang}\\)\n"
    question_content += f"\\end{{itemize}}\n\n"
    ...
    question_content += f"\\begin{{itemize}}\n"
    question_content += f"    \\item Tiệm cận ngang: \\(y = {tiemcan_ngang}\\)\n"
    question_content += f"    \\item Tiệm cận đứng: \\(x = {tiemcan_dung}\\)\n"
    question_content += f"\\end{{itemize}}\n\n"
    ...
    question_content += f"Kết quả: Có \\({sol_c['displayed_count']}\\) giá trị nguyên thỏa mãn\n\n"
